  ...
  return (
    ...
    >
      ...
      <Link
        ...
        href={`/news/${news.id}`}
        className={twMerge(buttonVariants({ variant: 'link' }), 'w-min ml-auto')}
      >
    ...
    <div id='news' className='mx-auto mb-16 mt-20 w-full max-w-6xl px-6'>
      <div className='flex flex-row items-center justify-between'>
        ...
        <Link
          ...
          className={twMerge(buttonVariants({ variant: 'default' }), 'hidden md:flex items-center gap-1')}
        >
          {t(HomeNewsButtonID)}
          <MdiChevronRight />
        </Link>
      ...
      <Link
        title={t(HomeNewsButtonID)}
        href='/news'
        className={twMerge(buttonVariants({ variant: 'default' }), 'flex md:hidden items-center gap-1 pt-3')}
      >
        {t(HomeNewsButtonID)}
        <MdiChevronRight />
      </Link>
