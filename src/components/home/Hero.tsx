...
export default async function Hero() {
  ...
  return (
    ...
    >
      <div className={styles.glassmain} data-aos='fade-right' data-aos-anchor-placement='top-bottom'>
        <div className='px-6 pt-10'>
          <h1 className='text-4xl font-normal uppercase text-primary md:text-5xl xl:text-6xl'>
            {t('home.hero.main.title')}
          </h1>
          <p className='mt-2 text-xl md:text-2xl'>{t('home.hero.main.sub-title')}</p>
      ...
      >
        ...
        <div className='flex h-full flex-col p-6 md:py-20'>
          ...
          <h2 className='text-4xl font-normal text-primary drop-shadow-lg'>{t('home.hero.target.title')}</h2>
