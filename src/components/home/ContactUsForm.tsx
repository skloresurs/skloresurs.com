  ...
  return (
    <>
      <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>{t(`home.contact-us.form.alerts.${alertData}.title`)}</AlertDialogHeader>
          <AlertDialogDescription>{t(`home.contact-us.form.alerts.${alertData}.description`)}</AlertDialogDescription>
          <AlertDialogFooter>
            <Button onClick={() => setIsOpen(false)}>{t('home.contact-us.form.alert-button')}</Button>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
      <form className='flex w-full max-w-[600px] flex-col gap-4' onSubmit={onSubmit}>
        <h2 className='uppercase' data-aos='fade-right'>
          {t('home.contact-us.title.default')}
          <span className='text-primary'>{t('home.contact-us.title.primary')}</span>
        </h2>
        <input
          name='firstname'
          id='firstname'
        ...
        <Button
          ...
          disabled={isLoading}
        >
          {t(`home.contact-us.form.submit-button.${isLoading ? 'loading' : 'default'}`)}
          <MdiSend />
        </Button>
        <div
          ...
          <div className='flex flex-row items-center gap-1'>
            ...
            <div className='flex flex-col'>
              ...
              <Link
                ...
                className={twMerge(buttonVariants({ variant: 'link' }), 'p-0 m-0 h-min')}
              >
                +38 (044) 355-05-99
              </Link>
            </div>
